...
{
    public class AuthenRep :IAuthenRep
    {
        public UserManager<AppUser> _userManager;
        public RoleManager<IdentityRole> _roleManager;

        public JWT _jwt;
        public AuthenRep(UserManager<AppUser> userManager, IOptions<JWT> jwt, RoleManager<IdentityRole> rmanager)
        {
